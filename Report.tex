...
\begin{document}
    ...
    \setcounter{page}{1}
        ...
        \section{Debuggers}
            ...
            a common scenario due to subtle parity differences between development and production systems. Such 
        ...
        \section{Motivation}
            ...
            The viability and findings of both explored options will be discussed 
