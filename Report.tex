...
\usepackage{microtype, caption, copyrightbox, textcomp}
\usepackage{hyperref}
\hypersetup{
    colorlinks,
    citecolor=black,
...
\begin{document}
    ...
    \setcounter{page}{1}
        ...
        \section{Project Summary}
            ...
            data to developers. We will utilize modern standards, tools and integrations to test the viability of less common and unexplored visualizations of distributed tracing data.

            In Chapter 2, we will introduce the history of distributed tracing, while also covering some common vocabulary relevant to the topic and where they originated. It will also
    ...
    \chapter{Background}
        \section{History}
            ...
            \subsection{OpenTelemetry}
                The OpenTelemetry\cite{opentelemetry} project comes about as a result of the merging of two previous projects, namely the previously mentioned OpenTracing
    ...
    \chapter{Design \& Implementation}
        \small{In this section, we will cover the different technical aspects, design decisions and components that played a role throughout the projects lifecycle.
        ...
        \section{Architecture Design}
            ...
            standard, with OpenTracing having much more comprehensive support from both application libraries and distributed tracing tools.
            ...
            Firstly, we will need a way of collecting trace data from applications. We will be using 
            
            we have a primary database in which these traces will be persisted. 


        \section{Backend API}

        \section{Service Topology Frontend}
