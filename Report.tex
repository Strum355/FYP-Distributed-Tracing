    ...
    \chapter{Design \& Implementation}
        ...
        \section{Architecture Design}
            ...
            \subsection{Debug Adapter}
                ...
                Conceptually, the role of the debug adapter created for this project is simple: given a trace ID, it can fetch the spans and their metadata for the trace ID, load the 
                ...
                around non-monorepo codebases, it should also have the ability to jump to and from files outside the currently opened codebase.
