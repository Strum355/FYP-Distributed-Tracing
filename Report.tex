        ...
        \section{Architecture Design}
            ...
            \subsection{Backend API}
                ...
                \subsubsection{GraphQL}
                    ...
                    \begin{lstlisting}[caption=Base GraphQL schema for the trace service API backend., language=GraphQL, gobble=24]
                        type Query{
                    ...
                    % TODO: base spans, tags, traces, logs graphql schema
            ...
            \subsection{Debug Adapter}
                ...
                With the stacktrace stored in the database as a span tag in string format, the backend GraphQL schema is adjusted by adding a field to the span type with an associated resolver and 
                ...
                will parse the raw stacktrace strings and returns them as a parsed and formatted stracktrace object to the GraphQL resolver.

                % TODO: updated graphql schema with stacktrace as field with resolver
